            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Blood Tips</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">1) Get plenty of sleep the night before you plan to donate. <br>

2) Avoid fatty foods, such as hamburgers, french fries or ice cream before donating. <br>
3) Drink an extra 16 ounces (473 milliliters) of water and other fluids before the donation.</p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
